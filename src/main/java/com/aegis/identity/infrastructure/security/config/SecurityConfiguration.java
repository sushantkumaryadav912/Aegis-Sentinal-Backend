...
public class SecurityConfiguration {
    ...
    public SecurityConfiguration(
            ...
            @Value("${aegis.security.cors.allowed-origins:http://localhost:3000,http://localhost:5173}") String allowedOriginsStr) {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedHeaders(List.of("Authorization", "Content-Type", "X-Organization-Id", "X-Workspace-Id", "X-Requested-With"));
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .headers(headers -> headers
                        ...
                        .addHeaderWriter(new org.springframework.security.web.header.writers.StaticHeadersWriter("Permissions-Policy", "geolocation=(), camera=(), microphone=()"))
                )
