...
public class JwtTokenProvider {
  ...
  @Value(
      "${app.jwt.secret:AegisSentinelPlatformSuperSecretKeyForHS512HMACSigningWhichMustBeAtLeast512BitsLongForSecuritySpecification2026}")
  ...
  public String generateAccessToken(
      UUID userId, UUID organizationId, String email, Set<String> roles, Set<String> permissions) {
    Date now = new Date();
