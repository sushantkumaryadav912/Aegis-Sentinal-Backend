...
public class OAuthIdentityProviderRegistry {
    ...
    public OAuthIdentityProvider resolve(Object principal) {
        return providers.stream()
                ...
                .findFirst()
                .orElseThrow(() -> new IllegalArgumentException("No matching OAuthIdentityProvider found for principal: " + principal));
    }
    ...
    public OAuthIdentityProvider getProvider(IdentityProvider provider) {
        return providers.stream()
                ...
                .findFirst()
                .orElseThrow(() -> new IllegalArgumentException("No OAuthIdentityProvider found for provider: " + provider));
    }
}
