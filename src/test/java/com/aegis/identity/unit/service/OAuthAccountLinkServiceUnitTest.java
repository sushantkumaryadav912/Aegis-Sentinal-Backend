...
class OAuthAccountLinkServiceUnitTest {
  ...
  void setUp() {
    service =
        new OAuthAccountLinkService(
            userRepository, userIdentityRepository, null, createSessionService);
  ...
  @Test
  @DisplayName(
      "Service Unit Test: Linking identity owned by another user throws IllegalStateException")
  void testLinkAuthenticatedUser_ownedByAnotherUser_throws() {
    ...
    UserIdentity existingIdentity =
        new UserIdentity(otherUser, IdentityProvider.GOOGLE, "sub-1234", "other@gmail.com");
